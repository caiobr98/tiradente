...
@section('content')
    <div class="">
        <ol class="breadcrumb">
            ...
            <li><a href="{{url('colaboradores')}}"><i class="fa fa-users"></i> Colaborador </a></li>
            <li class="active">
                Novo
            </li>
        </ol>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="row" action="{{url('colaboradores')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="nome">CRO</label>
                                    <input name="cro" class="form-control" type="text" id="cro" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
